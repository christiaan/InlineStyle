...
class InlineStyleTest extends TestCase
{
    /**
     * @var \Codeat3\InlineStyle
     */
    protected $object;
    protected $basedir;
    ...
    public function testIllegalXmlUtf8Chars()
    {
        ...
        $htmldoc = new InlineStyle("<html><body>".chr(2).chr(3).chr(4).chr(5)."</body></html>");
        $resultHtml = <<<HTML
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/REC-html40/loose.dtd">
<html><body></body></html>

HTML;
        // TODO: its a dummy test
        $this->assertEquals($resultHtml, $htmldoc->getHTML());
...
<link rel="alternate" href="somerssfeed" type="application/rss+xml" title="RSS feed">
<link rel="shortcut icon" href="somefavicon.ico" type="image/x-icon">
</head>
<body>
<style type="text/css">
    h1{
...
HTML;
        $this->assertEquals($resultHtml, $this->object->getHtml());
